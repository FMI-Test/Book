...
This repository contains raw multilingual writing that may be hard to read in its original form.
...
3. Clarify hidden context when needed.
...
- Remove obsolete folders like `Book.worktrees/` after merge.
- Keep files readable and consistently structured.