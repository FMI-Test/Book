...
[![Open in VS Code](https://img.shields.io/badge/Open%20in-VS%20Code-007ACC?logo=visualstudiocode&logoColor=white)](https://code.visualstudio.com/)
...
[![Cross Platform](https://img.shields.io/badge/Scripts-cross--platform-2ea44f)](https://code.visualstudio.com/docs/terminal/profiles)
...
- [`kb/Prince-of-Knowers.md`](kb/Prince-of-Knowers.md) — Bayazid Bastami, ecstatic utterance, hagiographic paradox, and a modern institutional parallel
